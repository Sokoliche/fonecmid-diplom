...
Функция МассовоеСозданиеДокРеализация(ДатаНачала, ДатаОкончания) Экспорт
	...
	|ГДЕ
	|	РеализацияТоваровУслуг.Дата МЕЖДУ &ВКМ_ДатаНачала И &ВКМ_ДатаОкончания
	|	И РеализацияТоваровУслуг.Договор = ВТ_Договоры.Ссылка
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	...
	Запрос.УстановитьПараметр("ВКМ_ДатаНачала", ДатаНачала);  
	Запрос.УстановитьПараметр("ВКМ_ДатаОкончания", ДатаОкончания);
